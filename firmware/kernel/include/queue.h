...
#define SYS_BT_PLUGGED            MAKE_SYS_EVENT(SYS_EVENT_CLS_PLUG, 8)
#define SYS_BT_UNPLUGGED          MAKE_SYS_EVENT(SYS_EVENT_CLS_PLUG, 9)
...
#if (defined(HIBY_R3PROII) || defined(HIBY_R1)) && defined(HAVE_TOUCHSCREEN)
