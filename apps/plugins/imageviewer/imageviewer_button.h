...
#define IMGVIEW_MENU            (BUTTON_POWER|BUTTON_REPEAT) 
...
#define IMGVIEW_PREVIOUS_REPEAT (BUTTON_VOL_DOWN|BUTTON_REPEAT)
#define IMGVIEW_MENU            BUTTON_POWER
#define IMGVIEW_SLIDE_SHOW      (BUTTON_HOME | BUTTON_REPEAT)
#define IMGVIEW_QUIT            BUTTON_HOME
...
#define IMGVIEW_LEFT            BUTTON_LEFT
#define IMGVIEW_RIGHT           BUTTON_RIGHT
#define IMGVIEW_NEXT            BUTTON_VOLUP
#define IMGVIEW_NEXT_REPEAT     (BUTTON_VOLUP|BUTTON_REPEAT)
#define IMGVIEW_PREVIOUS        BUTTON_VOLDOWN
#define IMGVIEW_PREVIOUS_REPEAT (BUTTON_VOLDOWN|BUTTON_REPEAT)
#define IMGVIEW_MENU            (BUTTON_POWER|BUTTON_REPEAT)
#define IMGVIEW_QUIT            (BUTTON_POWER|BUTTON_REL)
