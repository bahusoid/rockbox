...
#define STOPWATCH_QUIT          BUTTON_POWER|BUTTON_REL
#define STOPWATCH_START_STOP    BUTTON_RIGHT
#define STOPWATCH_RESET_TIMER   BUTTON_LEFT|BUTTON_REPEAT
#define STOPWATCH_QUIT          BUTTON_POWER|BUTTON_REPEAT
#define STOPWATCH_LAP_TIMER     BUTTON_LEFT|BUTTON_REL
#define STOPWATCH_SCROLL_UP     BUTTON_UP
#define STOPWATCH_SCROLL_DOWN   BUTTON_DOWN
